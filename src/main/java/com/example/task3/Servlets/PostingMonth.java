...
@WebServlet(name = "PostingMonth", urlPatterns = "/postings/month")
public class PostingMonth extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            String sql = "SELECT MatDoc, MaterialDescription, UserName, AuthorizedDelivery FROM postings WHERE MONTH(PstngDate) = ? AND AuthorizedDelivery = ?";
