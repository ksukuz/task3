...
@WebServlet(name = "PostingDay", urlPatterns = "/postings/day", loadOnStartup = 1)
public class PostingDay extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            String sql = "SELECT MatDoc, MaterialDescription, UserName, AuthorizedDelivery FROM postings WHERE DAY(PstngDate) = ? AND AuthorizedDelivery = ?";
